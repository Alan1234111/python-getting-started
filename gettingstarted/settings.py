...
# https://docs.djangoproject.com/en/6.0/ref/settings/#std-setting-SECRET_KEY
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'paas-bm-lab0.onrender.com', 'lab1-python.onrender.com']
